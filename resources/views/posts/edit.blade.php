...
<h1>Editer un post</h1>
	...
	@endif
		...
		<p>
			...
			<textarea name="description" id="description" lang="fr" rows="10" cols="50" placeholder="Le contenu du post" >{{ isset($post->description) ? $post->description : old('description') }}</textarea>
